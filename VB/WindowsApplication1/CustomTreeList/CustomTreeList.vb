    ...
    Friend Class CustomTreeList
        ...
        Private Sub CustomTreeList_DoubleClick(ByVal sender As Object, ByVal e As EventArgs)
            ...
            If ht IsNot Nothing AndAlso ht.Node IsNot Nothing AndAlso ht.HitInfoType = HitInfoType.RowIndent Then
                ...
                If ri IsNot Nothing AndAlso ri.IndentItems.Count > 0 Then
                    Dim levelByIndent = GetLevelByIndent(ri, p, ViewInfo.RC.LevelWidth)
        ...
        Private Shared Sub SetCollapsed(ByVal node As TreeListNode)
            ...
            End If
        End Sub
        Private Function GetLevelByIndent(ByVal ri As RowInfo, ByVal point As Point, ByVal levelWidth As Integer) As Integer
            Dim currentRect = ri.IndentBounds
            currentRect.Width = levelWidth
            For i = 0 To ri.IndentItems.Count - 1
